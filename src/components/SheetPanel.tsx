...
import { ShoppingCart, Users, TrendingUp, DollarSign, Percent, Target } from 'lucide-react'
...
export function SheetPanel({ isSales, sales, revenue, leads, mqls, mqlRate, cpa, roas, spend }: SheetPanelProps) {
  return (
