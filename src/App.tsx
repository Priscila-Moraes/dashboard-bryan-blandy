...
import { getAggregatedMetrics, getAdCreatives, aggregateCreatives, aggregateCampaigns, getLatestDailySummaryDate } from './lib/supabase'
import type { AggregatedCreative, AggregatedCampaign } from './lib/supabase'
...
export default function App() {
  ...
  async function loadData() {
    ...
    try {
      ...
      const allowCreativesFallback = isSalesProduct
